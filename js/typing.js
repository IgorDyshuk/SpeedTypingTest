...
async function updateBestScore(score, accuracy, language, time) {
  try {
    const response = await fetch(`${origin}/update_best_score`, {
      method: 'POST',
      headers: {
...
async function update_completed_tests() {
  try {
    const response = await fetch(`${origin}/update_completed_tests`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
async function update_typing_duration(typing_duration) {
  try {
    const response = await fetch(`${origin}/update_typing_duration`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
async function update_started_tests() {
  try {
    const response = await fetch(`${origin}/update_started_tests`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
